...
-- AddForeignKey
ALTER TABLE "TripReservation" ADD CONSTRAINT "TripReservation_tridId_fkey" FOREIGN KEY ("tridId") REFERENCES "Trip"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
